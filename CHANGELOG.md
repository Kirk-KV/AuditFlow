...
- staged audit project structure;
- CLI artifact generation for planning, audit program, workpapers, observations, report, feedback, and archive;
- project-level report and archive styling;
- event-based timeline facts;
